    ...
    <div class="cards" id="quest2">
        ...
        <div class="body-card" style="height: 230px;">
            <div class="question_1">
                <textarea id="que" style="height: 190px; font-size: 20px; font-weight: 600; bottom: 17px;" disabled>Señ@r ¿La falla se presenta en todos los dispositivos o en algunos? 📱📲
...
4.	Validar con más de un dispositivo que conecte el servicio
    ...
    <div class="cards" id="quest4" style="display: none;">
        ...
        <div class="body-card" style="height: 260px;">
            <div class="question_1">
                <textarea id="que3" style="height: 190px;" disabled>Señ@r xxxx esta falla no es del servicio como tal ya que la presentas en un solo dispositivo puedes validar con tu técnico de confianza, ¿deseas que te colabore en algo más? 
...
<script src="../../Controller/inter/inter5.js"></script>   
