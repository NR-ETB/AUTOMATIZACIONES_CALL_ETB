...
<body>
    ...
    <div class="container-general">
        ...
        <div class="delete" onclick="btn_edi2();" style="margin: 165px 0 0 30px;">
            ...
            <p>Cuando se selecciona esta opcion, el <span>ASESOR</span>, tiene la opcion de <span>GESTIONAR</span> a un <span>CLIENTE</span> a seleccionar.</p>
        </div>
        ...
        <div class="delete" onclick="btn_edi3();">
            ...
            <p>Cuando se selecciona esta opcion, el <span>ASESOR</span>, tiene la opcion de <span>GESTIONAR</span> a un <span>GRUPO DE CLIENTES</span> registrado en la base de datos.</p>
        </div>
